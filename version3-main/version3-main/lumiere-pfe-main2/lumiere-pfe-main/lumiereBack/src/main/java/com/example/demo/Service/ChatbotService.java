...
public class ChatbotService {
    ...
    public String getChatResponse(String userMessage, String userEmail, String platform) {
        ...
        if ("groq".equalsIgnoreCase(provider)) {
            ...
            return callGemini(userMessage, systemPrompt, userEmail, platform);
        }
    }

    private String callGemini(String userMessage, String systemPrompt, String userEmail, String platform) {
    ...
    private String callGroq(String userMessage, String systemPrompt, String userEmail, String platform) {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
