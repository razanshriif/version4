...
public class Ordre {
	...
	private String codepostalcharg;
	...
	public String getCodepostalcharg() {
		return codepostalcharg;
	}

	public void setCodepostalcharg(String codepostalcharg) {
		this.codepostalcharg = codepostalcharg;
	}
