...
public class PlaFileService {
    ...
    public void generatePlaFile(Ordre ordre) throws IOException {
        ...
        sb.append("1|DISPRO|").append(ordre.getClient()).append("|").append(ordre.getNomclient()).append("|")
                ...
                .append(ordre.getNombrePalettes()).append("||").append(ordre.getVolume().intValue()).append("|")
                .append(ordre.getVolume().intValue()).append("|||1||")
        ...
        Files.write(Paths.get("\\\\172.18.3.70\\tmsv14\\EDI\\AZIZA\\EDIDIVERS_" + new Date().getTime() + ".txt"),
