...
export class ArticleService {
  ...
  private baseUrl = 'http://172.18.3.125:8090/articles'; // Remplacez par l'URL de votre API

  constructor(private http: HttpClient) { }

  // Create
  createArticle(article: any): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}`, article, { headers: this.getAuthHeaders() });
  }
